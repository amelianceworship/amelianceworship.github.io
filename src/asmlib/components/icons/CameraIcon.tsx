...
export function CameraIcon(props: SvgIconProps) {
	return (
		...
		>
			...
			<path d="M12 17C14.2091 17 16 15.2091 16 13C16 10.7909 14.2091 9 12 9C9.79086 9 8 10.7909 8 13C8 15.2091 9.79086 17 12 17Z" strokeLinecap="round" strokeLinejoin="round" />
		</SvgIcon>
	);
}
